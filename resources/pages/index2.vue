...
export default {
  ...
  methods: {
    ...
    //     // console.log('s', document.documentElement)
    //     if (bottomOfWindow) {
    //       this.in("ii");
    //       this.scrolledToBottom = true
    //       // let length = this.feed.length ? this.feed.length - 1 : 0;
    //       // console.log("id", this.feed[length].id);
    //       // let sid = this.feed[length].id ? Number(this.feed[length].id) : "";
    //       // console.log("yesdfs", this.isFeedLoadingFinished);

    //       // if (!this.isFeedLoadingFinished && this.$route.name == "index") {
    //       //   console.log("yes");
    //       //   this.getFeed(sid);
    //       // }
    //     }
