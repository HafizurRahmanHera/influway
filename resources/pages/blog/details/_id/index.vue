                    ...
                    <div class="_2card _border_radious _padd25">
                      <div class="silience_section_all _mar_b20">
                        <div class="_dis_flex _3card_details">
                          <div class="_3card_details _flex_space">
                            <h4 class="silience_section_h4">{{blog.title}}</h4>
                          </div>
                        </div>

                        <div class="_comment">
                          <p class="_comment_time">{{blog.created_at | myDate}}</p>
                          <p
                            class="silience_section_p"
                            v-if="blog.blogCategory"
                          >{{blog.blogCategory.name}}</p>
                          ...
                          <img
                            ...
                            alt="Image"
                          />
                          <p class="silience_section_p_all" v-html="blog.text"></p>
                            ...
                            <div class="all_react">
                              <div class="react_left">
                                <ul>
                                  <li
                                    class="_cursor"
                                    v-if="blog.userLike!=null"
                                    @click="user_like_action(blog.feed_id,blog.user_id)"
                                  >
                      ...
                      <!-- <div class="_1like_comments _border_color">
                        <ul class="_1like_comm">
                          <li :class="{'like_active':blog.userLike!=null}" @click="user_like_action(blog.feed_id,blog.user_id)">
                        ...
                        <ul class="_1like_comm_num">
                          <li>{{blog.__meta__.like_count}} Likes</li>
                      ...
                      <div class="_border_color _all_comment img_cmnt">
                        ...
                        >
                          ...
                          <div class="_1comment_list_right">
                            ...
                            <p class="_1comment_list_right_text_p_one">{{comment.created_at | myDate}}</p>
                      ...
                      <div class="row">
                        ...
                        <div class="col-auto align-self-end">
                          ...
                          <div class="text-muted mb-2">
                            ...
                            <button
                              v-if="!loading"
                              @click="commentText(blog.feed_id)"
                              type="button"
                              class="conmment_send"
                            >
  ...
  async asyncData({ app, store, redirect, params }) {
    try {
      let [res1] = await Promise.all([
        app.$axios.get(`/getUserBlogById/${params.id}`)
      ]);
      // console.log(data)
      if (!res1.data) {
        redirect("/");
  ...
  methods: {
    ...
    async user_like_action(feed_id, feed_owner_id) {
      ...
      if (this.blog.userLike != null) {
        ...
        if (res.status === 200) {
          // this.s('Like removed')
          this.blog.userLike = null;
          this.blog.__meta__.like_count--;
        ...
        if (res.status === 200) {
          // this.s('Liked ')
          this.blog.userLike = res.data.like;
          this.blog.__meta__.like_count++;
