            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <!-- <a href="profile-posts.html" class="dropdown-item">Profile</a> -->
                  ...
                  <template v-if="authInfo.verification_status!=4">
                    <a @click="wr('Please verify your account!')"  class="dropdown-item" >
                      Create Site
                    </a>
                  </template>
                  <template v-else>
                    <a v-if="authInfo.apiToken" :href="`https://site.influway.com/session.php?token=${authInfo.apiToken}`" class="dropdown-item" >
                      {{authInfo.user_own_site? 'Edit Site': 'Create Site'}}
                    </a>
                  <!-- </template> -->
                  <!-- <template v-else> -->
                    <a v-else @click="wr('Please logout and login again!')"  class="dropdown-item" >
                      Create Site
                    </a>
                  </template>

                  <nuxt-link v-if="authInfo.verification_status==0 || authInfo.verification_status==2 || authInfo.verification_status==3" to="/user/kyc/form" class="dropdown-item">Verify Profile
                  </nuxt-link>
